...
```jsonc
{
  ...
  "supplierLabel": "string",
  "endpoints": {
    "manifest": "https://api.bidangelai.com/api/v1/buyer-facing/submission-packages/{packageId}/manifest",
    "publicKeys": "https://api.bidangelai.com/api/v1/buyer-facing/signing-keys",
    "revocationList": "https://api.bidangelai.com/api/v1/buyer-facing/signing-keys/revocation-list",
    "claimGraphList": "https://api.bidangelai.com/api/v1/buyer-facing/claim-graph/claims",
    "claimGraphDetail": "https://api.bidangelai.com/api/v1/buyer-facing/claim-graph/claims/{claimId}",
    "claimGraphQuery": "https://api.bidangelai.com/api/v1/buyer-facing/claim-graph/query",
  },
